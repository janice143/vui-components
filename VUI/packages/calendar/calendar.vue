  ...
  <div>
    <div class="x-calendar">
      <div class="x-calendar_header">
        <div class="x-calendar_header__title">
          {{ nowTime.year }} 年 {{ nowTime.month + 1 }} 月
        </div>
        <vui-row>
          <vui-btn plain type="main" @click="changePrevMonth">上个月</vui-btn>
          <vui-btn plain type="main" @click="changeNowMonth">今日</vui-btn>
          <vui-btn plain type="main" @click="changeNextMonth">下个月</vui-btn>
        </vui-row>
