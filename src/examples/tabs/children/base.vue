  ...
  >
    <template #showarea>
      ...
      <vui-tabs value="two">
        ...
        <vui-tab-panel label="标签二" name="two">标签二的内容</vui-tab-panel>
        <vui-tab-panel label="标签三" name="three">标签三的内容</vui-tab-panel>
      </vui-tabs>
    </template>
    <template #desc>
      <div>
        <code>value</code> 与 CtTabPane 的
        <code>name</code> 对应，用于标识当前激活的是哪一项，<code>name</code>
        值默认从 0 开始，默认激活第一项。
      </div>
    </template>
  </showcomponent>
