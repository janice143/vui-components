    ...
    <Showcomponent title="指令用法" :codes="code1">
      ...
      <template v-slot:showarea>
        <div>
          ...
          <vui-btn @click="toggleLoading">开/关</vui-btn>
        </div>
      </template>
    </Showcomponent>
    ...
    <Showcomponent title="全屏用法" :codes="code2">
      ...
      <template v-slot:showarea>
        <div>
          ...
          <vui-btn @click="toggleLoading2">开开</vui-btn>
        </div>
      </template>
    </Showcomponent>
    ...
    <Showcomponent title="Options用法" :codes="code3">
      ...
      <template v-slot:showarea>
        <div>
          ...
          <vui-btn @click="toggleLoading3">开/关</vui-btn>
        </div>
      </template>
    </Showcomponent>
    ...
    <Showcomponent title="服务用法" :codes="code4">
      ...
      <template v-slot:showarea>
        <div>
          ...
          <vui-btn @click="toggleLoading4">开开</vui-btn>
        </div>
      </template>
    </Showcomponent>
...
export default {
  ...
  <script>
    ...
    <div>
      <div v-loading.fullscreen="loading2" class="container"></div>
      <vui-btn @click="toggleLoading2">开/关</vui-btn>
    </div>
  </template>
